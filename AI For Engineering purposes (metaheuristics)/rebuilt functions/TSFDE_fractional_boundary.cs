...
{
    class ExampleA : IFunction
    {
        
        TSFDE_fractional_boundary tsfde = new TSFDE_fractional_boundary();
        public string Name => "Example A";
        public fitnessFunction Function => tsfde.fintnessFunction;
        ...
        {
            Double[,] domain = new Double[,] { { 0.1, 1.1, 1, -70, 250, -30, 50 }, {0.9, 1.9, 5, -20, 450, -10, 250 } };
            return domain;
        }
    }
